...
for txt, num in Target:
    rbut = tk.Radiobutton(ButFrame, text=txt, value=num, font=('Arial', 12), width=3, height=1, command=SetTarget,
                          variable=TargetV)
    rbut.place(x=Target_startx + num * 60, y=Target_starty)
...
but5=tk.Button(ButFrame, text='Bayes学习', font=('Arial', 12), width=10, height=1, command=BayesLearn)
but6=tk.Button(ButFrame, text='Bayes分类', font=('Arial', 12), width=10, height=1, command=BayesClassify)
